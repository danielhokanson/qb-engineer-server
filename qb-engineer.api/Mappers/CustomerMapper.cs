...
public static partial class CustomerMapper
{
    ...
    [MapperIgnoreSource(nameof(Customer.CreditHoldAt))]
    [MapperIgnoreSource(nameof(Customer.CreditHoldById))]
    [MapperIgnoreSource(nameof(Customer.LastCreditReviewDate))]
